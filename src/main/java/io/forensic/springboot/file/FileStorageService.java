...
import io.forensic.springboot.file.exception.FileStorageException;
import io.forensic.springboot.file.exception.MyFileNotFoundException;
...
public class FileStorageService {
	...
	public String storeFile(MultipartFile file) {
		// Normalize file name
		String fileName = StringUtils.cleanPath("temp.xlsx");
